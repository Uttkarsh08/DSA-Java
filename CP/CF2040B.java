...
public class CF2040B {
    // see the pattern , initially all are 0, we will make 1st 0 as 1, now , ideally, if we add a 1 at some other 0, first 1 and the new converted 1 can make some 0's -> 1 if the 2nd condition satisfies
